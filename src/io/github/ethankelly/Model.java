...
//		}
		...
		System.out.println(Winner.getWinners(filePath + "Data" + thisRound + ".csv", graphFile)[0]);

		System.setOut(texTable);
		System.out.println(Winner.getWinners(filePath + "Data" + thisRound + ".csv", graphFile)[1]);
