...
public class Set<Key extends Comparable<Key>> implements Iterable<Key> {
	...
	public static void testMethods() {
		...
		Out.println(set.contains("www.cs.princeton.edu"));
		Out.println(!set.contains("www.harvardsucks.com"));
		Out.println(set.contains("www.simpsons.com"));
		Out.println();

		Out.println("ceiling(www.simpsonr.com) = " + set.ceiling("www.simpsonr.com"));
		Out.println("ceiling(www.simpsons.com) = " + set.ceiling("www.simpsons.com"));
		Out.println("ceiling(www.simpsont.com) = " + set.ceiling("www.simpsont.com"));
		Out.println("floor(www.simpsonr.com)   = " + set.floor("www.simpsonr.com"));
		Out.println("floor(www.simpsons.com)   = " + set.floor("www.simpsons.com"));
		Out.println("floor(www.simpsont.com)   = " + set.floor("www.simpsont.com"));
		Out.println();
