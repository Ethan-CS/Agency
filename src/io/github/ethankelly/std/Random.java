 ...
 * shuffles the <code>high - low</code> elements in the array <code>a[]</code>, starting at index
...
public final class Random {
	...
	public static void main(String[] args) {
		...
		Out.println("seed = " + Random.getSeed());
		for (int i = 0; i < n; i++) {
			...
			Out.printf("%11d ", uniform(100000000000L));
			Random.shuffle(a);
			for (String s : a)
				Out.print(s);
			Out.println();
