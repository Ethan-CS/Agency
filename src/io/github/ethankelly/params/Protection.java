...
/**
 * The {@code Protection} enum stores values for each method of protection rating allocation in the model:
 * <ul>
 *     <li> {@link #RANDOM} - Protection is assigned as a pseudo-randomly generated value.
 *     <li> {@link #MIXED} - Protection is assigned based partially on proximity to infection and partially on a
